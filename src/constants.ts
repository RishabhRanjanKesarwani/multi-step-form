...
export const TEST_IDS = {
    ...
    signupDivider: 'signup-divider',
    personalInfoTextField: 'personal-info-text-field',
    personalInfoNextButton: 'personal-info-next-button',
    personalInfoErrorMessage: 'personal-info-error-message',
    officeDetailsTextField: 'office-details-text-field',
    officeDetailsNextButton: 'office-details-next-button',
    officeDetailsErrorMessage: 'office-details-error-message',
    confirmationPageTextField: 'confirmation-page-text-field',
    confirmationPageSubmitButton: 'confirmation-page-submit-button',
    confirmationPageUploadButton: 'confirmation-page-upload-button',
    confirmationPageCaptureButton: 'confirmation-page-capture-button',
    confirmationPageSignButton: 'confirmation-page-sign-button',
    webcamCaptureButton: 'webcam-capture-button',
